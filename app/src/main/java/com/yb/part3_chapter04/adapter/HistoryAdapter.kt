package com.yb.part3_chapter04.adapter
...
import com.yb.part3_chapter04.databinding.ItemHistoryBinding
    ...
    inner class HistoryItemViewHolder(private val binding: ItemHistoryBinding) :
        ...
        fun bind(historyModel: History) {
            ...
            binding.root.setOnClickListener {
                historyClickedListener(binding.historyKeywordTextView.text.toString())
            }
        }
